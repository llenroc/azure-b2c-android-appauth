...
class IdentityProvider {
    ...
    public static final IdentityProvider B2C = new IdentityProvider(
            "B2C",
            R.bool.b2c_enabled,
            NOT_SPECIFIED,
            R.string.b2c_authorize_uri, // auth endpoint is discovered
            R.string.b2c_token_uri, // token endpoint is discovered
            NOT_SPECIFIED, // dynamic registration not supported
            R.string.b2c_client_id,
            R.string.b2c_auth_redirect_uri,
            R.string.b2c_scope_string,
            R.drawable.btn_google,
            R.string.google_name,
            android.R.color.white);

    public static final List<IdentityProvider> PROVIDERS = Arrays.asList(B2C);
